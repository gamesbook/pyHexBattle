...
<!--
  ...
  Typical Usage with Instant Saxon: 
    saxon -o Battle.html mem_Battle.xml battle2bwSVG.xsl     
-->
<xsl:stylesheet 
  version="1.0"
...
xmlns="http://www.w3.org/2000/svg">
  ...
  <defs>
      ...
      /* units */
      .Unit {fill:white; stroke:black; stroke-width:1.25; }
      .Infantry, .Armour, .Artillery {fill:black; stroke:black; stroke-width:0.75; }
      .Bridge {fill:black; stroke:black; stroke-width:5; }
      .Town {fill:peru; stroke:peru; stroke-width:2; }
    ...
    <g id="armour">
      <use xlink:href="#unit" class="Unit" />
      <line x1="0" y1="0" x2="10" y2="10" class="Armour"/> 
      <line x1="3" y1="-2" x2="3" y2="0" class="Armour"/>
      <line x1="5.5" y1="-2" x2="5.5" y2="0" class="Armour"/>
      <line x1="7" y1="-2" x2="7" y2="0" class="Armour"/>
    </g>    
    <g id="artillery">
      <use xlink:href="#unit" class="Unit" />
    ...
    <g id="town">
      <rect x="20" y="20" width="15" height="30" class="Town"/>
      <rect x="60" y="40" width="20" height="40" class="Town"/>
    </g>
  ...
  <xsl:value-of select="hbml:scenario/hbml:title"/></tspan> - <tspan class="BattlePeriod"><xsl:value-of select="hbml:scenario/hbml:period"/>&#160;</tspan><tspan class="BattleDate"><xsl:call-template name="formatDate"><xsl:with-param name="year" select="hbml:scenario/hbml:date/@year"/><xsl:with-param name="month" select="hbml:scenario/hbml:date/@month"/><xsl:with-param name="day" select="hbml:scenario/hbml:date/@day"/><xsl:with-param name="style" select="$dateStyle"/></xsl:call-template></tspan></text>
